...
export const SYSTEM_INSTRUCTION = `You are "Naqeeb AI", the portfolio assistant for Naqeeb Ullah Mohammadi (goes by "Naqeeb Ullah").
...
VERIFIED DATA (JSON):
${JSON.stringify(VERIFIED_DATA, null, 2)}`;
